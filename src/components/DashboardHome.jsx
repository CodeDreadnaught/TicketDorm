    ...
    return (
        <section>
            ...
            <section className="flex flex-col gap-[1rem]">
                {eventsInformation.eventsMade > 0 ? recentEvents : <Link to="/sell-tickets" className="font-medium mt-[0.5rem]"><span className="border-b  border-[#007BFF] pb-[0.5rem] inline-block animate-bounce">Yes, I want to create an event</span></Link>}
            </section>
        </section>
    );
};
