...
const HomeFirstInfo = () => {
    return (
        <div className="bg-[linear-gradient(180deg,#030A55_0%,#020B6D_100%),linear-gradient(297.05deg,rgba(203,0,227,0.4)_0%,rgba(61,0,68,0.4)_100%)] text-white px-[1.6rem] py-[2.4rem] lg:px-[8.8rem] lg:py-[11.2rem]">
            <section className="mb-[2.4rem] lg:items-center lg:mb-[11.2rem] font-robotoSerif flex flex-col lg:flex-row gap-[1.6rem] lg:gap-[6.4rem] lg:justify-between">
                <section className="lg:w-[60rem]">
                    ...
                    <p className="leading-[2.5rem] lg:leading-[4rem] lg:text-[2.4rem] lg:text-justify">At TicketBooth, we prioritize your security and convenience. Our streamlined checkout process and encrypted payment gateways ensure that your transactions are safe and your personal information is protected. Buying tickets has never been easier – with just a few clicks, you can secure your spot at the hottest events in town.</p>
                </section>
