...
const HeroSearchBar = props => {
    ...
    return (
        <section className="h-[4rem] lg:h-[5rem] flex">
            <section className={`w-[75%] ${background} flex items-center px-[0.8rem] lg:px-[2rem]`}>
                ...
                <input type="text" className="inline-block w-[calc(100%-1.6rem)] text-black placeholder:text-black placeholder:text-[1.2rem] h-[2rem] lg:placeholder:text-[1.4rem] font-montserrat" placeholder="Search Events" />
            </section>
